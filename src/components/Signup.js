...
import useGetJWTToken from "../hooks/useGetJWTToken";
    ...
    <div className="h-svh w-full  bg-black bg-opacity-90 absolute z-20">
      <div className="h-auto w-[350px] mx-auto bg-white text-center z-20 border border-black relative top-8 rounded-xl">
        ...
        <form className="m-2">
          ...
          />
          <br />
          <button className="m-4 p-2 bg-black text-white w-7/12 rounded-lg hover:bg-blue-700 cursor-pointer" onClick={handleSignupClick}>
            Signup
          </button>
        </form>
      </div>
